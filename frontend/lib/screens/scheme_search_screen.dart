...
class SchemeSearchScreen extends StatefulWidget {
  ...
  @override
  State<SchemeSearchScreen> createState() =>
      _SchemeSearchScreenState();
}


class _SchemeSearchScreenState
    extends State<SchemeSearchScreen> {
  ...
  Future<void> _performSearch(
    ...
    try {
      ...
      final results =
          await _apiService.searchSchemes(
        request,
      );
      ...
      setState(() {
        ...
        if (e.statusCode == 400) {
          ...
          // -------------------------------------------
          // Real backend/network API error
          // -------------------------------------------
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              'BGE-M3 semantic relevance and '
                              'profile signals rank schemes. '
                              'Eligibility is validated separately.',
                              style:
                                  TextStyle(
                                fontSize:
                                    11.5,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            'Describe your business requirement to find relevant opportunities.',
            textAlign:
                TextAlign.center,
            style: TextStyle(
              fontSize: 12.5,
    ...
    return Container(
      ...
      child: const Column(
        children: [
          ...
          Text(
            'Encoding your request with BAAI BGE-M3 and calculating relevance...',
            textAlign:
                TextAlign.center,
            style: TextStyle(
              fontSize: 12,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            'Please describe your business need',
            textAlign:
                TextAlign.center,
            style: TextStyle(
              fontSize: 16,
          ...
          const Text(
            'Example: I need financial support to start a food processing business.',
            textAlign:
                TextAlign.center,
            style: TextStyle(
              fontSize: 11.5,
  ...
  // ---------------------------------------------------------
  // Valid query but no scheme results
  // ---------------------------------------------------------
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            'Try broadening your business need description or selecting a different goal or stage.',
            textAlign:
                TextAlign.center,
            style: TextStyle(
              fontSize: 12.5,
